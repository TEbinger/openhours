...
minetest.register_chatcommand("openinghours", {
 minetest.chat_send_player(current_player, "Öffnungszeiten Mo - Fr ".. opening_hours.weekday[1].. "bis".. opening_hours.weekday[2] .." Uhr, Sa./So. ".. opening_hours.weekend[1] .. " bis ".. opening_hours.weekend[2] .. "Uhr.")})
